...
public class MainActivity extends AppCompatActivity {
    ...
    public void stopService(View view) {
        ...
        btn.setBackgroundColor(Color.rgb( 	17, 17, 94));
        btn.setText("Start");
        btn.setEnabled(true);
        Button step = findViewById(R.id.shake);
        step.setText("");
...
//            Snackbar.make(findViewById(android.R.id.content),"Service Stopped!", Snackbar.LENGTH_LONG).show();
    ...
    public void startServiceV(View view) {
        ...
        Button btn = findViewById(R.id.start);
        btn.setTextColor(Color.rgb(138, 138, 138));
        btn.setBackgroundColor(Color.rgb( 152, 175, 199));
        btn.setText("Started");
        btn.setEnabled(false);
        Button step = findViewById(R.id.shake);
        step.setText("Shake your phone in case of emergency");
        Button stop = findViewById(R.id.stop);
